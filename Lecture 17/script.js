// Object(hashmap) : is one type of data structure, which can store multiple values of different datatypes based on key.
// to access value of the object we must have to use key.
// object store value in key:value pair.
// key: it is a unique name/id to identify value from the object.
// {} used to represent object in js
const obj = {
    name: "Aman",
    age: 28,
    course: "JS",
...
console.log(obj.address.pin[1].range)
...
// console.log(products.products[0].reviews[0].comment)

// products.products.forEach((p) => console.log(p.tags[0]))